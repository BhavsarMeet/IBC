<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
    ...
    <![endif]-->
            ...
            <body>
                <% UserEntity userModel=(UserEntity)session.getAttribute("user"); %>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="single_page6_single_slider dots_none">
                                                <c:if test="${empty newcardetails.carImages}">
                                                    <img class="img-fluid" src="images-ibc/no-image.png"
                                                    alt="No image found">
                                                </c:if>
                                                <c:forEach items="${newcardetails.carImages}" var="images">
                                                    <div class="item">
                                                        <div class="sp6_single_slider">
                                                            <div class="thumb">
                                                                <img class="img-fluid"  style="height:420px ;"  src="pictures\newcar${images}"
                                        ...
                                        <div class="col-lg-7 col-xl-8">
                                            <div class="single_page_heading_content">
                                                <div class="car_single_content_wrapper">
                                                    ...
                                                    <h2 class="title"><span>${newcardetails.carBrand}</span><span>
                                                            ${newcardetails.carModelName}</span></h2>
                                                    <p class="para"></p>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="single_page_heading_content text-start text-lg-end">
                                                ...
                                                <div class="price_content">
                                                    <div class="price mt60 mb10 mt10-md">
                                                        <h3><small
                                                                class="mr15"></small>&#8377; ${newcardetails.displayCarPrice}
                                                        </h3>
                                                    </div>
                                                </div>
                                            </div>
                                                            ...
                                                            <div class="wrapper">
                                                                ...
                                                                <ul class="list-group">
                                                                    <li
                                                                        ...
                                                                        <span
                                                                            class="schedule">${newcardetails.carBrand}</span>
                                                                    </li>
                                                                    <li
                                                                        class="list-group-item d-flex justify-content-between align-items-start">
                                                                        <div class="me-auto">
                                                                        ...
                                                                        <span
                                                                            class="schedule">${newcardetails.carModelName}</span>
                                                                    </li>
                                                                    <li
                                                                        class="list-group-item d-flex justify-content-between align-items-start">
                                                                        <div class="me-auto">
                                                                        ...
                                                                        <span
                                                                            class="schedule">${newcardetails.carBodyType}</span>
                                                                    </li>
                                                                    <li
                                                                        class="list-group-item d-flex justify-content-between align-items-start">
                                                                        <div class="me-auto">
                                                                        ...
                                                                        <span
                                                                            class="schedule">${newcardetails.carTransmissionType}</span>
                                                                    </li>
                                                                    <li
                                                                        class="list-group-item d-flex justify-content-between align-items-start">
                                                                        <div class="me-auto">
                                                                    ...
                                                                    <li
                                                                        ...
                                                                        <span
                                                                            class="schedule">${newcardetails.carManufacturingYear}</span>
                                                                    </li>
                                                                    <li
                                                                        class="list-group-item d-flex justify-content-between align-items-start">
                                                                        <div class="me-auto">
                                                                        ...
                                                                        <span
                                                                            class="schedule">${newcardetails.carMileage} Kmpl</span>
                                                                    </li>
                                                                    <li
                                                                        class="list-group-item d-flex justify-content-between align-items-start">
                                                                        <div class="me-auto">
                                                                        ...
                                                                        <span
                                                                            class="schedule">${newcardetails.carFuelType}</span>
                                                                    </li>
                                                                    <li
                                                                        class="list-group-item d-flex justify-content-between align-items-start">
                                                                        <div class="me-auto">
                                                                        ...
                                                                        <span
                                                                            class="schedule">${newcardetails.carEngineType}</span>
                                                                    </li>
                                                                    <li
                                                                        class="list-group-item d-flex justify-content-between align-items-start">
                                                                        <div class="me-auto">
                                                                        ...
                                                                        <span
                                                                            class="schedule">${newcardetails.carEngineCapacity} CC</span>
                                                                    </li>
                                                                    <li
                                                                        class="list-group-item d-flex justify-content-between align-items-start">
                                                                        <div class="me-auto">
                                                                        ...
                                                                        <span
                                                                            class="schedule">${newcardetails.carDoors}</span>
                                                                    </li>
                                                                    <li
                                                                        class="list-group-item d-flex justify-content-between align-items-start">
                                                                        <div class="me-auto">
                                                                        ...
                                                                        <span
                                                                            class="schedule">${newcardetails.carSeatingCapacity}</span>
                                                                    </li>
                                                                    <li
                                                                        class="list-group-item d-flex justify-content-between align-items-start">
                                                                        <div class="me-auto">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="newcarenquiry?vid=${newcardetails.carVariantId}&userid=${user.userId}"
