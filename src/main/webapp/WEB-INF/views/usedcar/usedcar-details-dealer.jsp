<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
    ...
    <![endif]-->
            ...
            <body>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="single_page6_single_slider dots_none">
                                                <c:if test="${empty usedCarDetails.usedCarImages}">
                                                    <img class="img-fluid" src="images-ibc/no-image.png"
                                                        alt="No image found">
                                                </c:if>
                                                <c:forEach items="${usedCarDetails.usedCarImages}" var="images">
                                                    <div class="item">
                                                        <div class="sp6_single_slider">
                                                            <div class="thumb">

                                                                <img class="img-fluid" src="pictures\usedcar${images}"
                                                ...
                                                <c:forEach items="${usedCarDetails.usedCarVideo}" var="video">
                                                    <div class="item">
                                                        <div class="sp6_single_slider">
                                                            <div class="thumb">
                                                                ...
                                                                <video class="img-fluid"
                                                                    onerror="this.src='images-ibc/no-image.png';"
                                                                    controls src="pictures\usedcar${video}">
                                            ...
                                            <div class="single_page_heading_content">
                                                <div class="car_single_content_wrapper">
                                                    <ul class="car_info mb20-md">
                                                        ...
                                                        <li class="list-inline-item"><a href="#">USED CAR</a></li>
                                                        <li class="list-inline-item"><span class="flaticon-clock-1 vam">
                                                            </span><a href="#" id="timer"></a>
                                                    ...
                                                    <h2 class="title">
                                                        <span>${usedCarDetails.usedCarModelData.usedCarBrand}</span><span>
                                                            ${usedCarDetails.usedCarModelData.usedCarModelName}</span>
                                                    </h2>
                                                    <p class="para"></p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="single_page_heading_content text-start text-lg-end">
                                                ...
                                                <div class="price_content">
                                                    <div class="price mt60 mb10 mt10-md">
                                                        <h3><small class="mr15"></small>&#8377;
                                                            ${usedCarDetails.usedCarDisplayPrice}
                                                        </h3>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="tab-pane fade" id="nav-description" role="tabpanel"
                                                        ...
                                                        <div class="listing_single_description bdr_none pl0 pr0">
                                                            ...
                                                            <!-- <p class="first-para">The all-new Volvo XC60 is a terrific
                                                                luxury
                                                                compact SUV. It's been fully redesigned for 2017 and
                                                                features
                                                                improvements across the board. These changes bump the
                                                                vehicle from
                                                                its previous midpack standing; it now resides with some
                                                                of the best
                                                                in the class. Some of the most notable improvements
                                                                include a
                                                                state-of-the-art infotainment system, more legroom for
                                                                rear-seat
                                                                riders, and peppy engine choices.</p>
                                                            <p class="mb25">Occupying over 8,000 square feet, perched
                                                                over 1,100
                                                                feet in the air with absolutely breathtaking panoramic
                                                                360-degree
                                                                views of all of New York City and the surrounding
                                                                tri-state area,
                                                                The 82nd Floor at 432 Park Avenue has been completely
                                                                reimagined by
                                                                one of the most sought-after design houses in London and
                                                                represents
                                                                an utterly unique opportunity to own a globally
                                                                significant
                                                                property.</p>
                                                            <p class="mt10 mb20">The Amrutha Lounge means port in the
                                                                Turkish
                                                                language, however the restaurant opens its doors to all
                                                                aspects of
                                                                the Mediterranean kitchen. The kitchen will be mostly
                                                                focused on
                                                                Mediterranean food; the owners of the restaurant are
                                                                young
                                                                professional chefs who can bring new, exciting tastes to
                                                                Angel,
                                                                Islington which will show through in the quality of food
                                                                they
                                                                prepare.</p> -->
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="wrapper">
                                                                ...
                                                                <ul class="list-group">
                                                                    <li
                                                                        ...
                                                                        <span
                                                                            class="schedule">${usedCarDetails.usedCarModelData.usedCarBrand}</span>
                                                                    </li>
                                                                    <li
                                                                        class="list-group-item d-flex justify-content-between align-items-start">
                                                                        <div class="me-auto">
                                                                        ...
                                                                        <span
                                                                            class="schedule">${usedCarDetails.usedCarModelData.usedCarModelName}</span>
                                                                    </li>
                                                                    <li
                                                                        class="list-group-item d-flex justify-content-between align-items-start">
                                                                        <div class="me-auto">
                                                                            <div class="day">Variant</div>
                                                                        </div>
                                                                        <span
                                                                            class="schedule">${usedCarDetails.usedCarModelData.usedCarVariant}</span>
                                                                    </li>
                                                                    <li
                                                                        class="list-group-item d-flex justify-content-between align-items-start">
                                                                        <div class="me-auto">
                                                                        ...
                                                                        <span
                                                                            class="schedule">${usedCarDetails.usedCarModelData.usedCarBodyType}</span>
                                                                    </li>
                                                                    <li
                                                                        class="list-group-item d-flex justify-content-between align-items-start">
                                                                        <div class="me-auto">
                                                                        ...
                                                                        <span
                                                                            class="schedule">${usedCarDetails.usedCarModelData.usedCarTransmissionType}</span>
                                                                    </li>
                                                                    <li
                                                                        class="list-group-item d-flex justify-content-between align-items-start">
                                                                        <div class="me-auto">
                                                                    ...
                                                                    <li
                                                                        ...
                                                                        <span
                                                                            class="schedule">${usedCarDetails.usedCarModelData.usedCarYear}</span>
                                                                    </li>
                                                                    <li
                                                                        class="list-group-item d-flex justify-content-between align-items-start">
                                                                        <div class="me-auto">
                                                                        ...
                                                                        <span
                                                                            class="schedule">${usedCarDetails.usedCarModelData.usedCarFuelType}</span>
                                                                    </li>
                                                                    <li
                                                                        class="list-group-item d-flex justify-content-between align-items-start">
                                                                        <div class="me-auto">
                                                                            <div class="day">KM Driven</div>
                                                                        </div>
                                                                        <span
                                                                            class="schedule">${usedCarDetails.usedCarDisplaykm}
                                                                            Km</span>
                                                                    </li>
                                                                    <li
                                                                        class="list-group-item d-flex justify-content-between align-items-start">
                                                                        <div class="me-auto">
                                                                            <div class="day">RTO Passing</div>
                                                                        </div>
                                                                        <span
                                                                            class="schedule">${usedCarDetails.usedCarModelData.usedCarRTO}</span>
                                                                    </li>
                                                                    <li
                                                                        class="list-group-item d-flex justify-content-between align-items-start">
                                                                        <div class="me-auto">
                                                                        ...
                                                                        <span class="schedule">&#8377;
                                                                            ${usedCarDetails.usedCarDisplayPrice}</span>
                                                                    </li>
                                                        ...
                                                        <div class="user_profile_location bdr_none pl0 pr0">
                                                            ...
                                                            <div class="upl_content d-block d-md-flex">
                                                                <p class="float-start fn-sm mb20-sm"><span
                                                                    ...
                                                                    Ranchview
                                                                    Dr. Richardson, California 62639</p>
                                                                    ...
                                                                    <div class="mbp_first d-flex db-414">
                                                                        ...
                                                                        <div class="flex-grow-1 ms-4 ml0-414">
                                                                            ...
                                                                            <p>Every single thing we tried with John was
                                                                                ...
                                                                                definitely go
                                                                                back to on our trip. John was also super
                                                                                friendly
                                                                                and passionate about Beşiktaş and
                                                                                Istanbul. </p>
                                                                        </div>
                                                                    </div>
                                                                    <div class="mbp_first d-flex db-414">
                                        ...
                                        <div class="col-lg-4 col-xl-4">
                                            <div class="offer_btns">
                                                <div class="text-end">
                                                    ...
                                                    <button class="btn btn-thm ofr_btn1 btn-block mt0 mb20"
                                                        ...
                                                        id="bidbutton"><span
                                                            class="flaticon-coin mr10 fz18 vam"></span>Make a Bid
                                                    </button>
                                                    <c:if test="${empty usedCarDetails.usedCarInspectionReport}">
                                                        <a href="" class="btn ofr_btn2 btn-block mt0 mb20"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#inspectionmodal"><span
                                                                class="flaticon-profit-report mr10 fz18 vam"></span>View
                                                            Report</a>
                                                        <!-- Modal -->
                                                        <div class="modal fade" id="inspectionmodal" tabindex="-1"
                                                            role="dialog" aria-labelledby="inspectionmodalTitle"
                                                            aria-hidden="true">
                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title"
                                                                            id="exampleModalLongTitle" style="font-weight: 700;">Inspection report</h5>
                                                                    ...
                                                                    <div class="modal-body">
                                                                       <p style="float: left;">Sorry,Inspection report not available!</p>
                                                                    </div>
                                                    ...
                                                    <c:if test="${not empty usedCarDetails.usedCarInspectionReport}">
                                                        <a href="inspection-report\used-car${usedCarDetails.usedCarInspectionReport}"
                                                            target="_blank"
                                                            class="btn ofr_btn2 btn-block mt0 mb20"><span
                                                                class="flaticon-profit-report mr10 fz18 vam"></span>View
                                                            Report</a>
                                                    </c:if>
                                            ...
                                            <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLongTitle">Make Bid
                                                            </h5>
                                                            <p><span>${usedCarDetails.usedCarModelData.usedCarYear}
                                                                </span><span>
                                                                    ${usedCarDetails.usedCarModelData.usedCarBrand}</span>
                                                                <span>${usedCarDetails.usedCarModelData.usedCarModelName}
                                                                </span><span>${usedCarDetails.usedCarModelData.usedCarVariant}
                                                                </span>
                                                            </p>
                                                        ...
                                                        <div class="modal-body">
                                                            <table class="table">
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <th>${usedCarDetails.highestBid}
                                                                        </th>
                                                                    </tr>
                                                                    <c:choose>
                                                                        <c:when
                                                                            test="${empty usedCarDetails.bidValueByDealer}">
                                                                            <tr>
                                                                        ...
                                                                        <c:otherwise>
                                                                            <tr>
                                                                                <th scope="row">Your Bid Value</th>
                                                                                <th>${usedCarDetails.bidValueByDealer}
                                                                                </th>
                                                                            </tr>
                                                                        </c:otherwise>
                                                                    </c:choose>
                                                                    <tr>
                                                                        ...
                                                                        <th>${usedCarDetails.usedCarDisplayPrice}
                                                                        </th>
                                                                    </tr>
                                                            ...
                                                            <form action="addbid" method="post">
                                                                <input type="hidden" name="carid"
                                                                    value="${usedCarDetails.usedCarModelData.usedCarId}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="text-center text-md-end mb30-sm">
                                    <a href="usedcarlist-dealer" class="more_listing">Show All Cars <span
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="listing_item_4grid_slider nav_none">
                                    <c:forEach items="${usedcardealer}" var="cars">
                                        <div class="item">
                                            <div class="car-listing">
                                                <div class="thumb">
                                                    <div class="tag">FEATURED</div>
                                                    <img src="pictures\usedcar${cars.usedCarFrontImage}"
                                                        onerror="this.src='images-ibc/no-image.png';" height="125%"
                                                        width="100%" alt="No image found">
                                                    <div class="thmb_cntnt3">
                                                        <ul class="mb0">
                                                            <li class="list-inline-item"><a
                                                                    href="usedcardetails?id=${cars.usedCarModelData.usedCarId}"
                                                ...
                                                <div class="details">
                                                    <div class="wrapper">
                                                        ...
                                                        <h5 class="price">&#8377;${cars.usedCarDisplayPrice}</h5>
                                                        <h6 class="title"><a
                                                                href="usedcardetails?id=${cars.usedCarModelData.usedCarId}"><span>${cars.usedCarModelData.usedCarBrand}</span>
                                                                <span>${cars.usedCarModelData.usedCarModelName}</span><span>
                                                                    -
                                                                    ${cars.usedCarModelData.usedCarYear}</span></a>
                                                        </h6>
                                                    ...
                                                    <div class="listing_footer">
                                                        <ul class="mb0">
                                                            <li class="list-inline-item"><span
                                                                    class="flaticon-road-perspective me-2 "></span><span>${cars.usedCarDisplaykm}
                                                                    Km</span></a>
                                                            </li>
                                                            <li class="list-inline-item"><span
                                                            ...
                                                            <li class="list-inline-item"><span class="me-2"><i
                                                                        class="fas fa-car"></i></span>${cars.usedCarModelData.usedCarBodyType}</a>
                                                            </li>
                                                            <li class="list-inline-item"><span
                                                                    class="flaticon-gear me-2"></span>${cars.usedCarModelData.usedCarRTO}</a>
                                                            </li>
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-md-4 col-lg-3 col-xl-3">
                                <div class="footer_about_widget">
                                    ...
                                    <p>India<br>3,Satkar Avenue,<br>Near Naroda Railway,<br>Nana Chiloda
                                        Ahmedabad-382330</p>
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-4 col-lg-3 col-xl-3">
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3 col-xl-3">
                                <div class="footer_contact_widget">
                                    ...
                                    <p>Monday - Friday: 09:00AM - 09:00PM<br>Saturday: 09:00AM - 07:00PM<br>Sunday:
                                        Closed</p>
                                </div>
                            </div>
                ...
                <script>
                    var list = [<c:forEach items="${usedcardealer}" var="data" varStatus="loop">

                        {

                            "desttime":"${data.usedCarModelData.usedCarBidEndTime}"
                    ...
                    function displayList(items) {
                        ...
                        var min = 1663419000000;
                        var endTime = 0;
                        var time = document.getElementById("time");
                        for (let i = 0; i < items.length; i++) {


                            var dest = new Date(items[i].desttime).getTime();
                            ...
                            var x = setInterval(function () {
                                ...
                                if (difference.toString().localeCompare('0:0:0') < 0) {
                                    location.reload();
                                }
                ...
                <script>
                    var item = "${usedCarDetails.usedCarModelData.usedCarBidEndTime}";
                    ...
                    function displayList(item) {
                        ...
                        var x = setInterval(function () {
                            ...
                            var dest = new Date(item).getTime();
                            var now = new Date().getTime();
                            var diff = dest - now;
                            ...
                            if (diff.toString().localeCompare('0:0:0') < 0) {

                                clearInterval(x);
                                timer.innerHTML = "Bid-Over";
