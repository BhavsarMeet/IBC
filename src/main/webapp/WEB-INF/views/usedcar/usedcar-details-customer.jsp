                                        ...
                                        <div class="col-lg-7 col-xl-8">
                                            <div class="single_page_heading_content">
                                                <div class="car_single_content_wrapper">
                                                    ...
                                                    <h2 class="title"><span>${usedCarDetails.usedCarModelData.usedCarBrand}</span><span>
                                                        ${usedCarDetails.usedCarModelData.usedCarModelName}</span></h2>
                                                    <p class="para"></p>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="single_page_heading_content text-start text-lg-end">
                                                ...
                                                <div class="price_content">
                                                    <div class="price mt60 mb10 mt10-md">
                                                        <h3><small
                                                                class="mr15"></small>&#8377; ${usedCarDetails.usedCarDisplayPrice}
                                                        </h3>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="tab-content col-lg-12" id="nav-tabContent">
                                                    <div class="tab-pane fade" id="nav-description" role="tabpanel"
                                                        ...
                                                        <div class="listing_single_description bdr_none pl0 pr0">
                                                            <h4 class="mb30">Description <span
                                                                    class="float-end body-color fz13">ID
                                                                    #9535</span></h4>
                                        ...
                                        <div class="col-lg-4 col-xl-4">
                                            <div class="offer_btns">
                                                <div class="text-end">
                                                    <button type="button"
                                                        class="btn btn-thm ofr_btn1 btn-block mt0 mb20"
                                                        data-bs-toggle="modal" data-bs-target="#iaminterestedmodal">
                                                        <span class="flaticon-coin mr10 fz18 vam"></span>
                                                        I am Interested</button>
                                                    <a  href="inspection-report\used-car${usedCarDetails.usedCarInspectionReport}"
                                                    target="_blank" class="btn ofr_btn2 btn-block mt0 mb20"><span
                                            ...
                                            <!-- Modal -->
                                            <div class="modal fade" id="iaminterestedmodal" tabindex="-1" role="dialog"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="usedcarenquiry?carid=${usedCarDetails.usedCarModelData.usedCarId}&userid=${user.userId}"
                                                                class="btn btn-outline-secondary btn-sm">Okay</a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="text-center text-md-end mb30-sm">
                                                <a href="usedcarlist-user" class="more_listing">Show All Cars <span
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="listing_item_4grid_slider nav_none">
                                                <c:forEach items="${usedcarcustomer}" var="cars">
                                                    <div class="item">
                                                        <div class="car-listing">
                                                            <div class="thumb">
                                                                ...
                                                                <div class="thmb_cntnt3">
                                                                    <ul class="mb0">
                                                                        <li class="list-inline-item"><a
                                                                                href="usedcardetailscustomer?carid=${cars.usedCarModelData.usedCarId}"
                                                            ...
                                                            <div class="details">
                                                                <div class="wrapper">
                                                                    ...
                                                                    <h6 class="title"><a
                                                                            href="usedcardetailscustomer?carid=${cars.usedCarModelData.usedCarId}"><span>${cars.usedCarModelData.usedCarBrand}</span>
