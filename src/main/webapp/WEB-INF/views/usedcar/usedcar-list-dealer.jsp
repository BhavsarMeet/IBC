<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" session="true" %>
    <%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
        <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
            <%@page import="com.model.usedcar.UsedCarModel" %>
                <!DOCTYPE html>
                                            ...
                                            <div class="col-xl-12">
                                                ...
                                                <c:if test="${not empty error}">
                                                    <div class="toast-container"
                                                        style="position: absolute; top: 10px; right: 10px; margin-top: 100px;">

                                                        <div class="toast fade show" data-autohide="true">
                                                            <div class="toast-header bg-danger">
                                                                <strong class="me-auto"
                                                                    style="font-weight: bold; color: black;"><i
                                                                        class="bi-globe"></i>
                                                                    Error</strong>
                                    ...
                                    <div class="container">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="siderbar_widget_header">
                                                                <h4 class="title mb0">Search Filters<a
                                                                        class="filter_closed_btn float-end"
                                                                        href="#"><span class="fas fa-times"></span></a>
                                                                </h4>
                                                            </div>
                                                                ...
                                                                <ul class="sasw_list mb0">
                                                                    ...
                                                                    <li>
                                                                        <div class="sidebar_priceing_slider_mobile">
                                                                            <div class="wrapper">
                                                                                <h5 class="subtitle">Filter by price
                                                                                </h5>
                                                                                <div class="mt20 ml10" id="slider">
                                                                                </div>
                                        ...
                                        <div class="row">
                                                            ...
                                                            <ul class="sasw_list mb0">
                                                                <form action="usedcarlist-dealer" id="myform">
                                                                    ...
                                                                    <li>
                                                                        <div class="search_option_two">
                                                                            <div class="candidate_revew_select">
                                                                                <input type="hidden" name="lowKm"
                                                                                    id="lowkm" value="${filter.lowKm}">
                                            ...
                                            <div class="col-lg-8 col-xl-9">
                                                    ...
                                                    <div class="listing_filter_row db-lg">
                                                        <div class="col-xl-5">
                                                            <div
                                                                ...
                                                                <p>We found <span
                                                                        class="heading-color fw600">${size}</span>
                                                                    Cars available
                                                                    for you</p>
                                                            </div>
                                                        </div>
                                                        <div class="col-xl-7">
                                                            <div
                                                                class="page_control_shorting right_area text-end tac-lg">
                                                                <ul>
                                                                    <li class="list-inline-item mb10-400"> <a id="open2"
                                                                            ...
                                                                            href="#"><img class="mr10"
                                                                                ...
                                                                                alt="filter-icon.svg">
                                                                            Filters</a> </li>
                                                                    <!-- <li class="list-inline-item short_by_text listone">
                                                                        Sort
                                                                        by:</li>
                                                                    ...
                                                                    <li class="list-inline-item list-gird"><a
                                                                            href="#"><img
                                                                                src="images-ibc/icon/list-grid.svg"
                                                                                alt="list-grid.svg"></a></li>
                                                                    <li class="list-inline-item list-list"><a
                                                                            href="#"><img
                                                ...
                                                <!-- Car Listing Starts -->
                                                <div class="row" >
                                                    <c:forEach items="${usedcardealerdata}" var="cars">
                                                            ...
                                                            <div class="car-listing">
                                                                <div class="thumb">
                                                                    ...
                                                                    <img src="pictures\usedcar${cars.usedCarFrontImage}"
                                                                        ...
                                                                        height="125%" width="100%" alt="No image found">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 col-xl-7">
                                                <div class="footer_about_widget text-start">
                                                    <div class="logo mb40 mb0-sm"><img src="images-ibc/logo.png"
                                                         alt="header-logo.png">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-md-4 col-lg-3 col-xl-3">
                                                <div class="footer_contact_widget">
                                                    ...
                                                    <p>Monday - Friday: 09:00AM - 09:00PM<br>Saturday: 09:00AM -
                                                        07:00PM<br>Sunday: Closed</p>
                                                </div>
                                            </div>
