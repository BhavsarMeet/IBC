                                ...
                                <div class="container-fluid pt-4 px-4">
                                    <div class="row g-4">
                                        <div class="bg-light rounded h-100 p-4">
                                            <h6 class="mb-4 text-center">Add IBC Employee</h6>
                                            <form action="addemployee" method="post">
                                                ...
                                                <div class="row mb-3">
                                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Enter
                                                        Name</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="employeeName" spellcheck="true" placeholder="employee Name" value="${employee.employeeName}"
                                                            class="form-control" id="inputEmail3" required>
                                                            <span style="color:red ;"><form:errors path="employee.employeeName"/></span>
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" name="employeeEmail" 
                                                            placeholder="employee Email" spellcheck="true" value="${email}"
                                                            class="form-control" id="employeeemail" required>
                                                            <span style="color:red ;"><form:errors path="employee.employeeEmail"/></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-3">
                                                    <label for="inputPassword3" class="col-sm-2 col-form-label">Enter
                                                        Phone</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="employeePhone" spellcheck="true" placeholder="employee Phone" value="${employee.employeePhone}"
                                                            class="form-control" id="inputPassword3" required>
                                                            <span style="color:red ;"><form:errors path="employee.employeePhone"/></span>
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <label for="inputPassword3" class="col-sm-2 col-form-label">Enter
                                                        Address</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" spellcheck="true" name="employeeAddress" placeholder="employee Address" value="${employee.employeeAddress}"
                                                            class="form-control" id="" cols="30" rows="3"
                                                            required/>
                                                            <span style="color:red ;"><form:errors path="employee.employeeAddress"/></span>
                                                    </div>
                                                </div>
