                                            ...
                                            <table class="table table-sm">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <th>${newcardata.carBrand}</th>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">Model</th>
                                                        <th>${newcardata.carModelName}</th>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">Variant</th>
                                                        <th>${newcardata.carVariantName}</th>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">Fuel Type</th>
                                                        <th>${newcardata.carFuelType}</th>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">Manufacturing Year</th>
                                                        <th>${newcardata.carManufacturingYear}</th>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">Body Type</th>
                                                        <th>${newcardata.carBodyType}</th>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">Car doors</th>
                                                        <th>${newcardata.carDoors}</th>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">Engine Type</th>
                                                        <th>${newcardata.carEngineType}</th>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">Engine Capacity</th>
                                                        <th>${newcardata.carEngineCapacity} CC</th>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">Mileage</th>
                                                        <th>${newcardata.carMileage} Kmpl</th>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">Seating Capacity</th>
                                                        <th>${newcardata.carSeatingCapacity}</th>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">Price</th>
                                                        <th>&#8377; ${newcardata.carPrice}</th>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">Images</th>
                                                        <th>
                                                            <c:if test="${not empty newcardata.carImages}">
                                                                <div class="slider-container">
                                                                    <div class="slider">
                                                                        <c:forEach
                                                                            items="${newcardata.carImages}"
                                                                            var="images">
                                                            ...
                                                            <c:if test="${empty newcardata.carImages}">
                                                    ...
                                                    <!-- <c:choose>
                                                        ...
                                                        <c:when
                                                            ...
                                                            <tr>
                                                                <th scope="row">Inspection Reporto</th>
                                                                <th> No Report Generated Yet</th>
                                                            </tr>
                                                        </c:when>
                                                        <c:otherwise>
                                                            <tr>
                                                                ...
                                                                <th scope="row">Inspection Report</th>
                                                                <th><a href="inspection-report\used-car${car.usedCarInspectionReport}" target="_blank">Inspection Report</a></th>
                                                            </tr>
                                                        </c:otherwise>
                                                    </c:choose> -->
                                                </tbody>
                                            ...
                                            <table class="table table-sm">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <th>${car.usedCarModelData.userEntitySellCar.userName}</th>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">Email</th>
                                                        <th>${car.usedCarModelData.userEntitySellCar.userEmail}</th>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>${car.usedCarModelData.userEntitySellCar.userAddress}</th>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
