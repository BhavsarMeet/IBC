...
<body>
                ...
                <div class="container-fluid pt-4 px-4">
                    <div class="bg-light text-center rounded p-4">
                        <div class="d-flex align-items-center justify-content-center mb-4">
                            <h6 class="mb-0">IBC Employee List</h6>
                            
                        </div>
                        <div class="my-3">
                            <input type="text" id="inputsearchemployee" class="form-control"
                            placeholder="Search employee" onkeyup="searchDealers()">
                        </div>
    ...
    <script>
        ...
        var list = [<c:forEach items="${employees}" var="employee" varStatus="loop">

            {"name":"${employee.employeeName}", "email": "${employee.employeeEmail}","phone":"${employee.employeePhone}","address":"${employee.employeeAddress}" }${loop.last ? '' : ','}
    ...
    <script>
        const searchDealers = () => {
            ...
            let filter = document.getElementById('inputsearchemployee').value.toUpperCase();
