													...
													<div class="extra-dashboard-menu dn-lg">
														<div class="ed_menu_list">
															<ul>
																...
																<li><a class="active" href="mysellcarlist"><span
											...
											<div class="row">
												<div class="col-lg-12">
													<div class="dashboard_favorites_contents p10-520">
														<div class="row">
															<c:forEach items="${sellcarlistforuser}" var="usedcar">
																...
																<div class="col-sm-6 col-xl-12 col-xxl-6">
																	<div class="car-listing list_style">
																		...
																		<div class="details">
																			<div class="wrapper">
																				<!-- <h5 class="price">&#8377;
																					${usedcar.usedCarModelData.usedCarBasePrice}
																				</h5> -->
																				<h6 class="title"><a
																			...
																			<div class="listing_footer">
																				<ul class="mb0">
																					...
																					<li class="list-inline-item"><a
																							href="#"><span
																								class="flaticon-gear me-2"></span>${usedcar.usedCarModelData.usedCarTransmissionType}</a>
																					</li>
																					<li class="list-inline-item"><a
																						href="#"><span
