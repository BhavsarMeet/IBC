                                            ...
                                            <div class="extra-dashboard-menu dn-lg">
                                                <div class="ed_menu_list">
                                                    <ul>
                                                        ...
                                                        <li><a class="active" href="userprofilepage?userid=${user.userId}"><span
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="new_property_form mb30">
                                                ...
                                                <form class="contact_form" action="updateuserprofile" method="post">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <div class="mb20">
                                                                        ...
                                                                        <input value="${userModel.userName}"
                                                                            ...
                                                                            placeholder="Name">
                                                                            <span style="color:red ;"><form:errors path="userModel.userName"/></span>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-6">
                                                                    <div class="mb20">
                                                                        <label class="form-label">City</label>
                                                                        <input value="${userModel.userAddress}"
                                                                            class="form-control form_control"
                                                                            type="text" name="userAddress"
                                                                            placeholder="Location">
                                                                            <span style="color:red ;"><form:errors path="userModel.userAddress"/></span>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-6">
                                                                    <div class="mb20">
                                                                        <label class="form-label">Phone Number</label>
                                                                        <input value="${userModel.userPhoneNumber}"
                                                                            class="form-control form_control"
                                                                            type="text" name="userPhoneNumber"
                                                                            placeholder="Phone">
                                                                            <span style="color:red ;"><form:errors path="userModel.userPhoneNumber"/></span>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-6">
                                                                    <div class="mb20">
                                                                        <label class="form-label">Email</label>
                                                                        <input value="${userModel.userEmail}"
                                                                            class="form-control form_control"
                                                                            type="text" name="userEmail"
                                                                            placeholder="Email">
                                                                            <span style="color:red ;"><form:errors path="userModel.userEmail"/></span>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-12">
                                                        ...
                                                        <div class="col-sm-6 col-lg-7">
                                                            <div class="mb20">
                                                                <input name="newpass" class="form-control form_control"
                                                                    ...
                                                                    <span style="color:red ;"><form:errors path="newpass"/></span>
                                                            </div>
