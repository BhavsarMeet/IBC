                ...
                <div class="col-lg-4 col-xl-5">
                  <div class="header_top_social_widgets text-center text-md-end">
                    <ul class="m0">
                      ...
                      <li class="list-inline-item"><a href="#"><span> <i class="fab fa-whatsapp"></i></span></a></li>
            ...
            <nav>
              <div class="container posr">
                ...
                <ul id="respMenu" class="ace-responsive-menu menu_list_custom_code wa text-end"
                  ...
                  <%if(dealerData==null && (userData!=null || userData==null) ){%>
                    <li>
                              ...
                              <%if(userData!=null){%>
                                ...
                                <%}else if(dealerData!=null){%>
                                  ...
                                  <%}else{%>
                                    ...
                                    <%}%>
                                      <li class="sidebar_panel">
                                        <a class="sidebar_switch pt0" href="#"><span></span></a>
                                      </li>
                </ul>
              </div>
            </nav>
