...
<!-- Mirrored from creativelayers.net/themes/voiture-html/page-error.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Sep 2022 06:59:09 GMT -->
<head>
<meta charset="utf-8">
...
<div class="wrapper">
	...
	<section class="our-error bgc-f9">
		<div class="container">
            ...
            <h3 class="subtitle">Enter OTP to verify your email and get register to IBCCARZ</h3>
						<div class="erro_code"></div>
					</div>
          <form action="registeruser" method="post">
            
            <input type="hidden" name="originalotp" value="${originalotp}">
            <input type="hidden" name="val" value="${val}">

            <input type="hidden" name="userEmail" value="${userEntity.userEmail}">
            <input type="hidden" name="userName" value="${userEntity.userName}">
            <input type="hidden" name="userAddress" value="${userEntity.userAddress}">
            <input type="hidden" name="userPassword" value="${userEntity.userPassword}">
            <input type="hidden" name="userPhoneNumber" value="${userEntity.userPhoneNumber}">
            
            <input type="text" name="otp" class="form-control m-2" placeholder="enter correct otp...">
           
           
           
            <div class="new_propertyform_btn">
              <button type="submit" class="btn btn-thm ad_flor_btn m-3">Submit</button>
          </div>
...
<script src="js-ibc/jquery.mmenu.all.js"></script> <script src="js/ace-responsive-menu.js"></script>
...
<!-- Mirrored from creativelayers.net/themes/voiture-html/page-error.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Sep 2022 06:59:10 GMT -->
</html>