                                                ...
                                                <div class="col-lg-12">
                                                    <div class="extra-dashboard-menu dn-lg">
                                                        <div class="ed_menu_list">
                                                            <ul>
                                                                <li><a class="active" href="dealerdashboard"><span
                                            ...
                                            <div class="row">
                                                ...
                                                <c:if test="${not empty success}">
                                                    <div class="toast-container"
                                                        style="margin-left: 650px; padding: 0;margin-top:-10px ;">
                                                ...
                                                <div class="col-xl-8">
                                                    <div class="breadcrumb_content mb50">
                                                        ...
                                                        <h2 class="breadcrumb_title">Hello,${dealerData.dealerName}!</h2>
                                                ...
                                                <div class="col-sm-6 col-lg-6">
                                                    ...
                                                    <div class="ff_one">
                                                        ...
                                                        <div class="detais text-end">
                                                            <div class="timer">${bidsbydealer}</div>
                                                            <p class="para">Total bids</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6 col-lg-6">
                                                    <div class="ff_one style2">
                                                        ...
                                                        <div class="detais text-end">
                                                            <div class="timer">${dealerpurchasedcars}</div>
                                                            <p class="para">Total Purchase</p>
                                                        </div>
                                                    </div>
                                                </div>
