                                            ...
                                            <div class="single_page_heading_content">
                                                <div class="car_single_content_wrapper">
                                                    <ul class="car_info mb20-md">
                                                        ...
                                                        <!-- <li class="list-inline-item"><a href="#" id="timer"><span
                                                                    class="flaticon-clock-1 vam"></span>2 years ago</a>
                                                        </li>
                                            ...
                                            <div class="single_page_heading_content text-start text-lg-end">
                                                ...
                                                <div class="price_content">
                                                    <div class="price mt60 mb10 mt10-md">
                                                        <!-- <h3><small
                                                                class="mr15"><del>$92,480</del></small>${usedCarDetails.usedCarModelData.usedCarBasePrice}
                                                        </h3> -->
                                                    </div>
                                                </div>
                                            </div>
                                                            ...
                                                            <div class="wrapper">
                                                                ...
                                                                <ul class="list-group">
                                                                    ...
                                                                    <li
                                                                        ...
                                                                        <span
                                                                            class="schedule">${usedCarDetails.usedCarDisplaykm} Km</span>
                                                                    </li>
                                                                    <li
                                                                        class="list-group-item d-flex justify-content-between align-items-start">
                                                                        <div class="me-auto">
                                                                    ...
                                                                    <li
                                                                        class="list-group-item d-flex justify-content-between align-items-start">
                                                                        <div class="me-auto">
                                                                            <div class="day">Base Price</div>
                                                                        </div>
                                                                        <span
                                                                            class="schedule">&#8377; ${usedCarDetails.usedCarDisplayPrice}</span>
                                                                    </li>
                                                                    <li
                                                                        class="list-group-item d-flex justify-content-between align-items-start">
                                                                        <div class="me-auto">
                                                                            <div class="day">Purchased Price</div>
                                                                        </div>
                                                                        <span
                                                                            class="schedule">&#8377; ${usedCarDetails.usedCarModelData.usedCarSoldPrice}</span>
                                                                    </li>
                                    ...
                                    <div class="item">
                                        <div class="car-listing">
                                            <div class="thumb">
                                                ...
                                                <img src="pictures\usedcar${cars.usedCarFrontImage}" height="125%" width="100%"
                                                onerror="this.src='images-ibc/no-image.png';"  alt="No image found">
